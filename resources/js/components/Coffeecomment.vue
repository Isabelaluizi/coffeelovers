<template>
<div>
    <div v-if="!this.notComment" class="overlay-paper" @click="changenotComment()">
    </div>
    <div class="container" id="container-coffeecomment">
        ...
        <div v-if="!this.notComment" id="comment-form" class="shadow-lg p-3 mb-5 bg-white rounded row justify-content-center justify-content-xl-center">
            <h5 class="change-color text-center"><strong><u>Comment</u></strong></h5>
            <p>{{this.userMessage}}</p>
            <div class="input-group mb-3">
                <input type="text" v-model="name" placeholder="Name" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <div class="input-group">
                <textarea class="form-control" v-model="comment" placeholder="Comment" type="text" aria-label="With textarea" rows="5"></textarea>
            </div>
