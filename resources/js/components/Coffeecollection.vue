<template>
  <div>
    <div id="container-wallpaper"></div>
    <div id="inside-container" class="container">
      ...
      <div class="row justify-content-center justify-content-md-center justify-content-xl-center">
        <div class="col-4 col-md-3 col-xl-2">
          <a
            class="btn btn-dark button-styled"
            role="button"
        ...
        <li class="list-group-item" v-for="coffee in filteredCoffees" :key="coffee.id">
          <div class="row justify-content-xl-center">
            ...
            <div class="col-xl-2 order-xl-1">
              <img
                class="img-fluid rounded mx-auto d-block picture-coffee"
                :src="'/storage/' + coffee.picture"
              />
            </div>
            <div class="text-center col-12 col-xl-12 order-xl-12">
              <a
                ...
                id="button-comment"
                role="button"
                :href="'/showCoffeeComments/'+ coffee.id"
              >Comment</a>
            </div>
          </div>
        </li>
    ...
    <div>
      Icon made from
      <a href="http://www.onlinewebfonts.com/icon">Icon Fonts</a> is licensed by CC BY 3.0
    </div>
    <div>
      Icons made by
